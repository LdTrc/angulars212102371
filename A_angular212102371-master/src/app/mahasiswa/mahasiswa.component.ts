...
export class MahasiswaComponent implements OnInit, AfterViewInit {
  ...
  postRecord(): void {
    ...
    if (nim.length == 0) {
      alert('NIM belum diiisi');
      return;
    }
    if (nama.length == 0) {
      alert('Nama belum diiisi');
      return;
    }
    if (tempatLahir.length == 0) {
      alert('Tempat lahir belum diiisi');
      return;
    }
    if (tanggalLahir.length == 0) {
      alert('Tanggal lahir belum diiisi');
      return;
    }
    if (alamat.length == 0) {
      alert('Alamat belum diiisi');
      return;
    }
    if (tahunMasuk.length == 0) {
      alert('Tahun masuk belum diiisi');
      return;
    }
